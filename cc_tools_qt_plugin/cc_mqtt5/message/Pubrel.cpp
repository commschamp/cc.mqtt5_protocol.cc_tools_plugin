...
static QVariantMap createProps_packetId(bool serHidden)
{
    ...
    using Field = ::cc_mqtt5::message::PubrelFields<cc_tools_qt_plugin::cc_mqtt5::options::DefaultOptions>::PacketId;
...
{
    static_cast<void>(serHidden);
    using Field = ::cc_mqtt5::message::PubrelFields<cc_tools_qt_plugin::cc_mqtt5::options::DefaultOptions>::ReasonCode;
    return
...
{
    static_cast<void>(serHidden);
    using Field = ::cc_mqtt5::message::PubrelFields<cc_tools_qt_plugin::cc_mqtt5::options::DefaultOptions>::Properties;
    return
        cc_tools_qt::property::field::ForField<Field>()
            .name(Field::name())
            .serialisedHidden(serHidden)
