...
static QVariantMap createProps_packetId(bool serHidden)
{
    ...
    using Field = ::cc_mqtt5::message::UnsubackFields<cc_tools_qt_plugin::cc_mqtt5::options::DefaultOptions>::PacketId;
...
{
    static_cast<void>(serHidden);
    using Field = ::cc_mqtt5::message::UnsubackFields<cc_tools_qt_plugin::cc_mqtt5::options::DefaultOptions>::Properties;
...
{
    static_cast<void>(serHidden);
    using Field = ::cc_mqtt5::message::UnsubackFields<cc_tools_qt_plugin::cc_mqtt5::options::DefaultOptions>::List;
    return
